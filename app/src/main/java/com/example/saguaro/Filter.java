...
public class Filter extends AppCompatActivity {
    ...
    /**
     * Gallery intent will open a new screen which includes all the gallery images.
    ...
    /**
     * create a camera intent (a camera preview) So the user can capture image from here.
